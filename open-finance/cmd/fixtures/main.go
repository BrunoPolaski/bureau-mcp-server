...
import (
	...
	"github.com/BrunoPolaski/open-finance/internal/infra/thirdparty/database"
...
var loadOrder = []fixtureTarget{
	...
	{FileName: "bank_account_profiles.json", TableName: "bank_account_profiles"},
	...
	{FileName: "bank_statements.json", TableName: "bank_statements"},
	{FileName: "cash_flow_analyses.json", TableName: "cash_flow_analyses"},
	{FileName: "recurring_transactions.json", TableName: "recurring_transactions"},
	{FileName: "data_sharing_consents.json", TableName: "data_sharing_consents"},
