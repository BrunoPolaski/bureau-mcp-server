...
import (
	...
	"github.com/BrunoPolaski/internal-registry/internal/infra/thirdparty/database"
...
func main() {
	...
	if _, err := os.Stat("/.dockerenv"); err == nil {
		...
		if os.Getenv("ENV") == "production" {
			...
			os.Setenv("DATABASE_URL", "postgres://root:123456@127.0.0.1:5433/internal-registry?sslmode=disable")
		}
	}
