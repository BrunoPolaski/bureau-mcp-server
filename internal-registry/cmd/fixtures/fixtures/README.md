...
JSON fixtures for the Internal Registry MCP server. Each file is a JSON array whose objects use **snake_case** keys matching database columns (GORM default naming).
