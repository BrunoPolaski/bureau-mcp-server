...
import (
	...
	internal_mcp "github.com/BrunoPolaski/internal-registry/internal/interfaces/mcp"
	"github.com/joho/godotenv"
	"github.com/mark3labs/mcp-go/server"
	"go.uber.org/zap"
)

// @title Internal Registry MCP Server
// @version 1.0
// @description This is the API documentation for the Internal Registry MCP Server.
//
// license.name MIT
// @host localhost:8080
//
