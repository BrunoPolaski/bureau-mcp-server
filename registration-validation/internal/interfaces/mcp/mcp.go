...
import (
	...
	"github.com/BrunoPolaski/registration-validation/internal/infra/thirdparty/validator"
	"github.com/BrunoPolaski/registration-validation/internal/interfaces/mcp/tools"
...
func InitMCPServer() *server.MCPServer {
	...
	s := tools.NewMCPServer(
		...
		services.NewRegistrationValidationService(rf),
	)
