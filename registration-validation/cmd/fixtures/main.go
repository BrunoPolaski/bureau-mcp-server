...
import (
	...
	"github.com/BrunoPolaski/registration-validation/internal/infra/thirdparty/database"
...
var loadOrder = []fixtureTarget{
	...
	{FileName: "document_validations.json", TableName: "document_validations"},
	{FileName: "fiscal_regularities.json", TableName: "fiscal_regularities"},
	{FileName: "employment_link_validations.json", TableName: "employment_link_validations"},
	{FileName: "compliance_checks.json", TableName: "compliance_checks"},
...
func main() {
	...
	if _, err := os.Stat("/.dockerenv"); err == nil {
		...
		if os.Getenv("ENV") == "production" {
			...
			os.Setenv("DATABASE_URL", "postgres://root:123456@127.0.0.1:5433/registration-validation?sslmode=disable")
		}
	}
